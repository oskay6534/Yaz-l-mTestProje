...
VALUES
('drali', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Dr. Ali Demir', 'drali@hastane.com', '5559876543', 'DOKTOR', 45, 'ERKEK', NOW(), true),
('drayse', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Dr. Ayşe Yılmaz', 'drayse@hastane.com', '5559876544', 'DOKTOR', 38, 'KADIN', NOW(), true),
('drmehmet', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Dr. Mehmet Kaya', 'drmehmet@hastane.com', '5559876545', 'DOKTOR', 50, 'ERKEK', NOW(), true),
('drfatma', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Dr. Fatma Şahin', 'drfatma@hastane.com', '5559876546', 'DOKTOR', 42, 'KADIN', NOW(), true),
('drcan', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Dr. Can Öztürk', 'drcan@hastane.com', '5559876547', 'DOKTOR', 48, 'ERKEK', NOW(), true);

-- 2. DEMO HASTA KULLANICILAR (Sifre: hasta123)
-- ================================================
INSERT INTO kullanicilar (kullanici_adi, sifre, ad_soyad, email, telefon, rol, yas, cinsiyet, kayit_tarihi, aktif)
VALUES
('ahmet', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Ahmet Yılmaz', 'ahmet@gmail.com', '5551234567', 'HASTA', 35, 'ERKEK', NOW(), true),
('elif', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Elif Kaya', 'elif@gmail.com', '5551234568', 'HASTA', 28, 'KADIN', NOW(), true);

-- 3. ADMIN KULLANICI (Sifre: admin123)
-- ================================================
INSERT INTO kullanicilar (kullanici_adi, sifre, ad_soyad, email, telefon, rol, yas, cinsiyet, kayit_tarihi, aktif)
VALUES
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 'Admin User', 'admin@hastane.com', '5550000000', 'ADMIN', 30, 'BELIRTILMEMIS', NOW(), true);
